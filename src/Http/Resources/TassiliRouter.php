...
class TassiliRouter extends Controller
{
   ...
   public function update(Request $request)
    ...
    $record =  \Tassili\Prime\Models\TassiliCrud::find($request->id);
...
if ($request->filled('panel')) {
     $panels = \Tassili\Prime\Models\TassiliCrud::where('panel',$request->panel)
             ->paginate(10) ;
}

if (!$request->filled('panel')) {
     $panels = \Tassili\Prime\Models\TassiliCrud::paginate(10) ;
}
    ...
    {  
        \Tassili\Prime\Models\TassiliCrud::where('id',$request->id)->update([
    ...
    {  
        \Tassili\Prime\Models\TassiliCrud::destroy($request->id);
    }  
