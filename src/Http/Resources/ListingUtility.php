...
class ListingUtility
{
    ...
    public function __construct(array $settings = [])
    {
        ...
        $this->tassiliSettings = [
            ...
            'permissionsToDeleteById' =>  $settings['permissionsToDeleteById'] ?? '',
            'permissionsToUpdateById' =>  $settings['permissionsToUpdateById'] ?? '',
        ];
    }
     ...
     public function addBulk(array $options): void
    {
        ...
        $options['url'] = $url;
        $this->groupActions[$options['url']] =  $options;
    }
    ...
    public function getInertiaData(): array
    {
        return [
            ...
            'showDelete' =>    $this->tassiliSettings['showDelete'],
            'showEdit' =>    $this->tassiliSettings['showEdit'],
            'permissionsToDeleteById' => $this->tassiliSettings['permissionsToDeleteById'],
            'permissionsToUpdateById' => $this->tassiliSettings['permissionsToUpdateById'],
